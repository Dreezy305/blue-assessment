  ...
  return (
    <div className="flex flex-row justify-around items-baseline w-full mb-4 px-3">
      <div className="topbar mr-5 flex flex-row relative">
        <input
          type="text"
          className="mt-4 px-14 pr-28 outline-none h-12 rounded-lg border border-solid border-dark focus:outline-none placeholder:text-dark"
      ...
      <div className="ml-5 flex flex-row justify-around items-center topbar_left pr-5 space-x-7">
        <div className="relative cursor-pointer">
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="#3733a2"
            // style="fill: #3733a2;transform: ;msFilter:;"
          >
