...
function Unsplash({ data }: any): JSX.Element {
  ...
  return (
    <div className="mx-auto pt-6 mb-5 pb-5">
      <div className="grid grid-cols-3 gap-x-4 w-full md:grid md:grid-cols-5 md:gap-y-6 md:gap-x-6  lg:grid lg:grid-cols-5 lg:gap-y-6 lg:gap-x-0 md:w-full">
        {images.map((image: any, index: any) => {
          return (
            <div
              className="w-full md:w-full lg:w-10/12 pb-3 flip-box"
              key={index}
            >
